resource "aws_elastic_beanstalk_environment" "eereeda-bean-prod" {
  name                = "eereeda-bean-prod"
  application         = aws_elastic_beanstalk_application.eereeda-prod.name
  ...
  depends_on = [aws_security_group.eereeda-bean-elb-sg, aws_security_group.eereeda-prod-sg]
